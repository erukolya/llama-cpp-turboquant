...
extern "C" {
    ...
    */
    ...
    // Cumulative MUL_MAT_ID node executions by backend device class.
    struct ggml_backend_sched_moe_exec_stats {
        uint64_t cpu_ops;
        uint64_t accelerator_ops;
    };

    GGML_API struct ggml_backend_sched_moe_exec_stats ggml_backend_sched_get_moe_exec_stats(ggml_backend_sched_t sched);
    GGML_API void                                     ggml_backend_sched_reset_moe_exec_stats(ggml_backend_sched_t sched);
